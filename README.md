This Sobipro add-on makes it possible for Sobipro template developer to have field positions in the template where the user can set where to show fields in the template.
